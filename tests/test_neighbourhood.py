import pytest
from bricolage.neighbourhood import NetworkNeighbourhood, Collection, PopulationNeighbourhood
...
def test_population(bowtie_database):
    ...
    print nayb.neighbours.fitnesses.mean(), sum(nayb.neighbours.fitnesses == 1.0)
